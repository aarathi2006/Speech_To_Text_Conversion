...
Supports audio file upload (WAV, MP3, M4A)

Accurate and fast transcription

Simple and user-friendly interface

Useful for transcription and voice-based applications
# 🛠️ Technologies Used
...
PyAudio / Audio Processing Tools

# ⚙️ How It Works

1.User provides audio input (file or microphone)

2.Audio preprocessing and noise handling

3.Speech recognition model processes audio
